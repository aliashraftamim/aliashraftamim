...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://ali-ashraf.vercel.app)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ali-ashraf-tamim/)
...
```typescript
const ali = {
  role:       "Backend Engineer @ SparkTech Agency (Betopia Group)",
...
> *I don't just write code — I ship systems that go live.*
...
**🟢 Backend Engineer — SparkTech Agency** `Jan 2024 → Present`
*Betopia Group · Mohakhali, Dhaka*

- Architected & shipped backends for **12+ production apps** end-to-end
- Owned all critical decisions — DB schema, architecture, cloud infra
- Solo-configured **AWS EC2, VPC, S3 · DigitalOcean · Nginx** on every deployment
- Built **6+ Next.js admin panels** alongside full backend development
- Integrated **Stripe, Mollie, Firebase FCM, OAuth 2.0** and real-time WebSocket chat

**⚫ Web Developer → Team Leader — SM Technology** `Nov 2023 → Jun 2024`
*Betopia Group · Banasree, Dhaka*

- Promoted to **Team Leader** after independently managing key projects
- Trained & mentored the development team on best practices and delivery standards
...
<img src="https://streak-stats.demolab.com?user=aliashraftamim&theme=tokyonight&hide_border=true&border_radius=8" alt="GitHub Streak Stats" />
...
| | |
|--|--|
| 🖥️ | [**How to Securely Host Your Backend on a VM — Nginx, Domain & SSL**](https://ali-ashraf.vercel.app/blog/hosting-backend-on-vm-nginx-domain-ssl) |
| 🤖 | [**How to Stay Relevant and Level Up Your Career in the Age of AI**](https://ali-ashraf.vercel.app/blog/career-in-the-age-of-ai) |
| 🧩 | [**How to Think Through a Big Project Before Writing a Single Line of Code**](https://ali-ashraf.vercel.app/blog/how-to-think-before-you-build) |
